...
var GeraCPF = /*#__PURE__*/function () {
  function GeraCPF() {
    ...
    this.cpfSemDigito = this.rand();
    this.valida = new _ValidarCpf__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCpf() {
      var digito1 = this.valida.pegaDigito(this.cpfSemDigito);
      var digito2 = this.valida.pegaDigito(this.cpfSemDigito + digito1);
      var novoCpf = this.cpfSemDigito + digito1 + digito2;
...
var ValidarCpf = /*#__PURE__*/function () {
  ...
  _createClass(ValidarCpf, [{
    ...
    value: function valida() {
      ...
      var digito1 = this.pegaDigito(cpfParcial);
      var digito2 = this.pegaDigito(cpfParcial + digito1);
      var novoCpf = cpfParcial + digito1 + digito2;
      if (novoCpf === this.cpfLimpo) return true;
    }
  }, {
    key: "pegaDigito",
    value: function pegaDigito(cpfParcial) {
      var arrayCpf = Array.from(cpfParcial);
      var multiplicador = arrayCpf.length + 1;
      var total = arrayCpf.reduce(function (acumulador, valor) {
    ...
    key: "isSequencia",
    value: function isSequencia(cpfLimpo) {
      var sequencia = cpfLimpo[0].repeat(cpfLimpo.length);
